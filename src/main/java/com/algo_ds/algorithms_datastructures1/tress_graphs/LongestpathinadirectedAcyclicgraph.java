package com.algo_ds.algorithms_datastructures1.tress_graphs;// Java program to find the longest
// path in the DAG 

import java.util.ArrayList;

// graph class 
class LongestpathinadirectedAcyclicgraph {

    int vertices;
    ArrayList<Integer> edge[];

    LongestpathinadirectedAcyclicgraph(int vertices) {
    ...
    public static void main(String[] args) {
        int n = 5;
        LongestpathinadirectedAcyclicgraph graph = new LongestpathinadirectedAcyclicgraph(n);
        // Example-1
        graph.addEdge(1, 2);
        graph.addEdge(1, 3);
        graph.addEdge(3, 2);
